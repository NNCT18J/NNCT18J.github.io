    ...
    return (
        <div className="flex">
            ...
            <div className="flex-initial grid grid-flow-row grid-cols-1 xl:grid-cols-2 2xl:grid-cols-3 gap-12 mx-auto">
                {props.data.map(work => 
                    <div className="flex flex-col bg-gray-50 text-gray-500 rounded-3xl shadow-xl"
                        style={{width: '400px'}}>
                        ...
                        <div className="m-5 flex-1 flex flex-col">
                            ...
                            <div className="ml-auto mr-4">
                                <a href={work.link.uri} target="_blank" rel="noreferrer"
                                    className="px-3 py-2 rounded-lg text-lg no-underline bg-gray-200 text-gray-500 hover:bg-gray-300">
                                    {work.link.title}
                                </a>
                            </div>
                        </div>
